...
Parse.prototype = {
    ...
    getSchemas: function (callback) {
        parseRequest.call(this, 'GET', this._api_version + '/schemas', null, callback);
    },

    getSchema: function (className, callback) {
        parseRequest.call(this, 'GET', this._api_version + '/schemas/' + className, null, callback);
    },

    insertSchema: function (className, data, callback) {
        parseRequest.call(this, 'POST', this._api_version + '/schemas/' + className, data, callback);
    },

    updateSchema: function (className, data, callback) {
        parseRequest.call(this, 'PUT', this._api_version + '/schemas/' + className, data, callback);
    },

    deleteSchema: function (className, callback) {
        parseRequest.call(this, 'DELETE', this._api_version + '/schemas/' + className, callback);
    }
